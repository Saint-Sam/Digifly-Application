...
Digifly App uses Qt for Python's supported `pyside6-deploy` path. The checked-in
...
The build appears at `dist/Digifly App.app`. It is ad-hoc signed so its modified
